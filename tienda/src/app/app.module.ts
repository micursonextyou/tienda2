...
import { AppComponent } from './component/app/app.component';import { BrowserAnimationsModule } from '@angular/platform-browser/animations';
//mis componentes
...
@NgModule({
  ...
  entryComponents:[DialogMiTiendaComponent,DialogMiSeguridadComponent]
})
